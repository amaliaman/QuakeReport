...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return an {@link ArrayList<Earthquake>} list to represent a list of earthquakes.
     */
    ...
    private static List<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < jsonFeaturesArray.length(); i++) {
                JSONObject jsonFeatureObject = jsonFeaturesArray.getJSONObject(i);
